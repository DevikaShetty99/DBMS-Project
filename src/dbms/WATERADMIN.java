 ...
 * @author Sneha
 */
public class WATERADMIN extends javax.swing.JFrame {

    /**
     * Creates new form WATERADMIN
     */
    public WATERADMIN() {
        initComponents();
        table_update();
...
Connection con1;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, -1, 370));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WATERADMIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
