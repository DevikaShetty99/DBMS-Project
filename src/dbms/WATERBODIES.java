 ...
 * @author Sneha
 */
public class WATERBODIES extends javax.swing.JFrame {

    /**
     * Creates new form WATERBODIES
     */
    public WATERBODIES() {
        initComponents();
        table_update();
...
Connection con1;
                ...
                
        {
          ...
          DriverManager.registerDriver(new OracleDriver());
            ...
            insert = con1.prepareStatement("select distinct zname,to_char(tdate,'dd/mm/yyyy') as ddate from teamform where task='Water Bodies' ");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 150, -1, 270));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WATERBODIES.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
