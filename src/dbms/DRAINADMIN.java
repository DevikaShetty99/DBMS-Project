 ...
 * @author Sneha
 */
public class DRAINADMIN extends javax.swing.JFrame {

    /**
     * Creates new form DRAINADMIN
     */
    public DRAINADMIN() {
        initComponents();
        table_update();
...
Connection con1;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 180, -1, 350));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/2EDIT.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1080, 640));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DRAINADMIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
